// travel-journey.js — wires "destination-card" cards into the shared My Journey bookmark + search system
    ...
    bookmarkButtons.forEach((btn) => {
      ...
      btn.addEventListener('click', (e) => {
        ...
        window.Journey.toggle({
          id, explorerPage: 'travel.html', title, thumbnail, category
        });
        setPressed();
      });
    });

    window.Journey.registerSearchItems('travel.html', cards.map((card) => ({
      id: card.dataset.id,
