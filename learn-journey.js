// learn-journey.js — wires "course-card" cards into the shared My Journey bookmark + search system
    ...
    bookmarkButtons.forEach((btn) => {
      ...
      btn.addEventListener('click', (e) => {
        ...
        window.Journey.toggle({
          id, explorerPage: 'learn.html', title, thumbnail, category
        });
        setPressed();
      });
    });

    window.Journey.registerSearchItems('learn.html', cards.map((card) => ({
      id: card.dataset.id,
